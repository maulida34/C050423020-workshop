@extends('layouts.app')
@section('title')Payment {{ $workshop->name }}
@endsection
@section('content')
<div class="h-[112px]">
    <x-nav/>
                        ...
                        <div class="flex flex-col gap-6">
                            <label class="flex flex-col gap-4">
                                ...
                                <div class="group input-wrapper flex items-center rounded-xl p-4 gap-2 bg-[#FBFBFB] overflow-hidden">
                                    ...
                                    <input type="text" name="customer_bank_name" id="bankname" class="appearance-none bg-transparent w-full
                            ...
                            <label class="flex flex-col gap-4">
                                ...
                                <div class="group input-wrapper flex items-center rounded-xl p-4 gap-2 bg-[#FBFBFB] overflow-hidden">
                                    ...
                                    group-focus-within:flex group-has-[:valid]:flex" alt="icon">
                                    <input type="text" name="customer_bank_account" id="fullname" class="appearance-none bg-transparent
                            ...
                            <label class="flex flex-col gap-4">
                                ...
                                <div class="group input-wrapper flex items-center rounded-xl p-4 gap-2 bg-[#FBFBFB] overflow-hidden">
                                    ...
                                    group-focus-within: flex group-has-[:valid]:flex" alt="icon">
                                    <input type="text" name="customer_bank_number" id="banknumber" class="appearance-none bg-transparent
                                    w-full outline-none text-1g leading-[27px] font-semibold placeholder:font-medium
