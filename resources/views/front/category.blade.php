            ...
            <a href="{{route('front.details', $itemNewWorkshop->slug) }}" class="card">
                <div class="flex flex-col h-full justify-between rounded-3xl p-6 gap-9 bg-white">
                    <div class="flex flex-col gap-[18px]">
                        <div class="flex items-center gap-3">
                            <div class="w-16 h-16 rounded-full flex shrink-0 overflow-hidden">
                                <img src="{{Storage::url($itemNewWorkshop->instructor->avatar) }}" class="w-full h-full object-cover" alt="Instructor Avatar">
                            </div>
                        ...
                        <div class="thumbnail-container relative h-[200px] rounded-x1 bg-[#D9D9D9] overflow-hidden">
                            ...
                            @if($itemNewWorkshop->is_open)
                                ...
                                <div class="absolute top-3 left-3 flex items-center rounded-full py-3 px-5 gap-1 bg-aktiv-orange text-white">
                                    <img src="{{asset('/images/icons/timer-start.svg')}}" class="w-6 h-6" alt="icon">
                                    <span class="font-semibold">STARTED</span>
                                </div>
                                @else
                                <div class="absolute top-3 left-3 flex items-center rounded-full py-3 px-5 gap-1
                                bg-aktiv-green text-white z-10">
                                    <img src="{{asset('/images/icons/medal-star.svg' )}}" class="w-6 h-6" alt="icon">
                            ...
                            @else
                                ...
                                bg-aktiv-red text-white z-10">
                                    <img src="{{asset('/images/icons/sand-timer.svg')}}" class="w-6 h-6"
                                    alt="icon">
                        ...
                        <div class="card-detail flex flex-col gap-2">
                            <div class="flex items-center gap-3">
                                <div class="flex items-center gap-1">
                                    <img src="{{asset('/images/icons/calendar-2.svg')}}" class="w-6 h-6 flex shrink-0" alt="icon">
                                    <span class="font-medium text-aktiv-grey">{{$itemNewWorkshop->started_at->format('M d, Y')}}</span>
                                </div>
                                <div class="flex items-center gap-1">
                                    <img src="{{asset('/images/icons/timer.svg')}}" class="w-6 h-6 flex shrink-0" alt="icon">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <img src="{{asset('/images/icons/arrow-right.svg')}}" class="w-12 h-12 flex shrink-0" alt="icon">
                    </div>
                </div>
            </a>
            @empty
    ...
    <footer class="w-full p-[52px] bg-white">
        <div class="flex flex-col w-full max-w-[1176px] mx-auto gap-8">
            <div class="flex flex-col items-center gap-4">
                <img src="{{asset('/images/logos/Logo-blue.svg')}}" class="h-10" alt="logo">
